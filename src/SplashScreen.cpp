...
void SplashScreen::onInit()
{
    ...
    mSprite4.setTexture(getContext().textures.get((int)Textures::ID::TitleLogo));
    ...
    getContext().fonts.load((int)Fonts::ID::SplashScreenFont, "qrc:/../media/Fonts/ARHERMANN.ttf");
    ...
    mText2.setFont(getContext().fonts.get((int)Fonts::ID::SplashScreenFont));
    ...
    getContext().textures.load((int)Textures::ID::SFMLLogo, "qrc:/../media/Textures/SFMLLogo.png");
    getContext().textures.get((int)Textures::ID::SFMLLogo).setSmooth(true);

    mSprite1.setTexture(getContext().textures.get((int)Textures::ID::SFMLLogo));
    ...
    getContext().textures.load((int)Textures::ID::Box2DLogo, "qrc:/../media/Textures/Box2DLogo.png");
    getContext().textures.get((int)Textures::ID::Box2DLogo).setSmooth(true);

    mSprite2.setTexture(getContext().textures.get((int)Textures::ID::Box2DLogo));
    ...
    getContext().textures.load((int)Textures::ID::QtLogo, "qrc:/../media/Textures/QtLogo.png");
    getContext().textures.get((int)Textures::ID::QtLogo).setSmooth(true);

    mSprite3.setTexture(getContext().textures.get((int)Textures::ID::QtLogo));
    ...
    mText3.setFont(getContext().fonts.get((int)Fonts::ID::SplashScreenFont));
    mText3.setString("by");
